        ...
        <div class="<?= $conversationClass ?>">
            <a href="index.php?action=messages&user2_id=<?= $conversation->getOtherUserId($_SESSION['user']['id']) ?>&conversation_id=<?= $conversation->getId() ?>">
                ...
                <div class="conversationBadge">
                    <div>
                        <img src="/uploads/avatars/<?= htmlspecialchars($conversation->otherUser->getAvatar()) ?>"
                             alt="Avatar de l'autre utilisateur de la conversation" class="mediumAvatar">
                    </div>
                ...
                <?php foreach ($messages as $message) {
                    if ($message->getSenderId() != $_SESSION['user']['id']) { ?>
                        ...
                        <div class="messageHeader">
                            <img src="/uploads/avatars/<?= $otherUserAvatar ?>" alt="Avatar de l'expéditeur du message"
                                 class="smallAvatar">
